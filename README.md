...
<p align="center">
  <a href="https://github.com/Krellixx?tab=followers">
...
Click here: **[Launch Krellixx Descent](https://krellixx.github.io/Krellixx/)**  
If the link is not live yet, enable GitHub Pages in repository settings:

1. Go to `Settings` -> `Pages`.
2. Source: `Deploy from a branch`.
3. Branch: `main` and folder: `/docs`.
4. Save, wait ~1 minute, refresh.

---

## Behind the scenes

The full interactive build is in `docs/` and powered by HTML/CSS/JS.
GitHub profile README does not execute custom JavaScript, so the game runs via GitHub Pages for full immersion.
